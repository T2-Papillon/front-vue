    ...
    <div class="row align-items-center justify-content-between g-3 pb-4">
        <div class="col-auto">
            <div class="title-area">
                ...
                <h2 class="h2">
                    <input type="text" v-model="project_title" class="form-control" id="title" placeholder="제목을 입력해주세요." required />
                </h2>
            </div>
        </div>
        <div class="col-auto">
    ...
    <table class="table table-borderless fs-9 mb-5 border-top border-translucent">
        ...
        <tbody>
            <tr>
                <th>작성자</th>
                <td>
                    <input type="text" class="form-control" id="pm" readonly />
                </td>
                <th>작성일</th>
            ...
            <tr>
                <th>진행률</th>
                <td><input type="number" v-model="project_percent" class="form-control" min="0" max="100" step="1" placeholder="0부터 100까지의 숫자를 입력하세요." /></td>
                <th></th>
                <td></td>
            </tr>
            <tr>
